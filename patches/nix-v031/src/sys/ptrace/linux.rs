...
cfg_if! {
    if #[cfg(any(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_arch = "s390x"),
                 all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "gnu"),
                 target_env = "uclibc"))] {
        #[doc(hidden)]
...
libc_enum! {
    ...
    pub enum Request {
        ...
        #[cfg(any(all(target_os = "android", target_pointer_width = "32"),
                  all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), any(target_env = "musl",
                                               target_env = "ohos",
                                               target_arch = "mips",
        ...
        PTRACE_ATTACH,
        PTRACE_DETACH,
        #[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), any(target_env = "musl",
                                           target_env = "ohos",
                                           target_arch = "mips",
                                           target_arch = "mips32r6",
                                           target_arch = "mips64",
        ...
        PTRACE_GETSIGINFO,
        PTRACE_SETSIGINFO,
        #[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(any(target_arch = "mips",
                                               target_arch = "mips32r6",
                                               target_arch = "mips64",
                                               target_arch = "mips64r6"))))]
        PTRACE_GETREGSET,
        ...
        #[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(any(target_arch = "mips",
                                               ...
                                               target_arch = "mips64r6"))))]
        PTRACE_PEEKSIGINFO,
        #[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "gnu",
