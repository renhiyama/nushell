...
libc_enum! {
    ...
    pub enum BaudRate {
        ...
        #[cfg(linux_android)]
        B2000000,
        #[cfg(any(target_os = "android", all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(target_arch = "sparc64"))))]
        B2500000,
        #[cfg(any(target_os = "android", all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(target_arch = "sparc64"))))]
        B3000000,
        #[cfg(any(target_os = "android", all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(target_arch = "sparc64"))))]
...
libc_enum! {
    ...
    pub enum SpecialCharacterIndices {
        ...
        VLNEXT,
        #[cfg(not(any(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_arch = "sparc64"),
...
#[cfg(any(
    all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_arch = "sparc64"),
    solarish,
    target_os = "aix",
    target_os = "haiku",
))]
...
libc_bitflags! {
    ...
    pub struct ControlFlags: tcflag_t {
        ...
        #[cfg(linux_android)]
        CBAUD;
        #[cfg(any(target_os = "android", all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(target_arch = "mips"))))]
        CMSPAR;
        #[cfg(any(target_os = "android",
                  all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"),
