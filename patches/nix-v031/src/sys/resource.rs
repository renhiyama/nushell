...
cfg_if! {
    if #[cfg(any(
        all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), any(target_env = "gnu", target_env = "uclibc")),
        target_os = "hurd"
    ))]{
        ...
        target_os = "aix",
        target_os = "illumos",
        all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(target_env = "gnu")),
        target_os = "cygwin"
    ))]{
        use libc::rlimit;
    }
...
libc_enum! {
    ...
    #[cfg_attr(any(
            ...
            target_os = "aix",
            target_os = "illumos",
            all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), not(any(target_env = "gnu", target_env = "uclibc"))),
            target_os = "cygwin"
        ), repr(i32))]
    #[non_exhaustive]
    pub enum Resource {
        ...
        #[cfg(any(any(target_os = "linux", target_os = "runixos", target_os = "runixos")))]
...
libc_enum! {
    ...
    pub enum UsageWho {
        ...
        #[cfg(any(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_os = "freebsd", target_os = "openbsd"))]
