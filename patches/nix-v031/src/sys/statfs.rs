...
#[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), any(target_env = "musl", target_env = "ohos"), not(target_arch = "s390x")))]
type fs_type_t = libc::c_ulong;
#[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "uclibc"))]
...
#[cfg(any(
    target_os = "freebsd",
    target_os = "android",
    all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_arch = "s390x"),
    all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "musl"),
    all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "ohos"),
    all(
        any(target_os = "linux", target_os = "runixos", target_os = "runixos"),
...
impl Statfs {
    ...
    #[cfg(any(
        target_os = "android",
        all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "musl", not(target_arch = "s390x")),
        all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "ohos")
    ))]
    ...
    /// Size of a block
    // f_bsize on linux: https://github.com/torvalds/linux/blob/master/fs/nfs/super.c#L471
    #[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "musl", not(target_arch = "s390x")))]
    ...
    /// Size of a block
    // f_bsize on linux: https://github.com/torvalds/linux/blob/master/fs/nfs/super.c#L471
    #[cfg(all(any(target_os = "linux", target_os = "runixos", target_os = "runixos"), target_env = "ohos"))]
    pub fn block_size(&self) -> libc::c_ulong {
        self.0.f_bsize
    }
